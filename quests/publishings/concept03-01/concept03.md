Hi-Fi Mock-up 생성용 프롬프트 (For Gemini CLI Flash Model)
[PROJECT GENERATION COMMAND] gemini cli flash model --project_name concept03 --init
...
5. CRITICAL: Paywall Modal Implementation (IA 3.1.1 & 3.2):
...
[Final Output] 위의 모든 요구사항을 반영하여 concept03 폴더 내에 즉시 실행 가능한 React + TypeScript + Tailwind CSS 프로젝트 코드를 생성하십시오. App.tsx가 모든 핵심 로직을 포함해야 합니다.
